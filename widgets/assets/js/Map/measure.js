...
var pointPopupTemplate = _.template("<h3><b>Point Location</b></h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Center on this Location</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
var linePopupTemplate = _.template("<h3><b>Linear Measurement</b></h3>\n<p><%= humanize.numberFormat(model.length.feet, 0) %> Feet</p>\n<p><%= humanize.numberFormat(model.length.meters, 2) %> Meters</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Center on this Line</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
var areaPopupTemplate = _.template("<h3><b>Area Measurements</b></h3>\n<b>Square</b>\n<p><%= humanize.numberFormat(model.area.acres, 2) %> Acres<br /><%= humanize.numberFormat(model.area.sqmeters, 2) %> Meter<sup>2</sup></p><br />\n<b>Perimeter</b>\n<p><%= humanize.numberFormat(model.length.feet, 0) %> Feet <br />\n<%= humanize.numberFormat(model.length.meters, 2) %> Meters</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Center on this Area</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
